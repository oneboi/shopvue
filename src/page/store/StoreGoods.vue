    ...
    <el-col :span="24" class="toolbar">
      ...
      <el-form >
        ...
        <el-form-item>
         ...
         <el-form-item>
           <el-button type="success" @click="add()">添加所选商品进入门店{{$route.params.code}}</el-button>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" @click="routerback()">返回门店列表</el-button>
        </el-form-item>
		  	 	...
		  	 	<div gooods>
		  		 	...
		  		 	<!--table列表-->
			  <el-table :data="goodslist"   @selection-change="changeFun" highlight-current-row  style="width: 100%;">
...
export default {
  ...
  methods:{
     ...
     axios.post2("StoreGoods/select",params).then((data)=>{
      console.log("查到到的数据：");
    ...
    add(){
          ...
          type: 'warning'
        	...
        	for(var  i in this.multipleSelection){
        	    var obj={};
        		obj.cid=this.multipleSelection[i].cid;
        		obj.gid=this.multipleSelection[i].id;
        		obj.sn=this.multipleSelection[i].sn;
        		obj.price=this.multipleSelection[i].price;
        		obj.code=this.code;
        		arr.push(obj);
        	}   
        	var postdata=arr;
         axios.post("StoreGoods/add",postdata).then((data)=>{
		         console.log(data);
